...
export class Initialize1596219118915 implements MigrationInterface {
    name = 'Initialize1596219118915'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query("CREATE TABLE `book_positions` (`id` int NOT NULL AUTO_INCREMENT, `column_no` int NOT NULL, `row_no` int NOT NULL, `created_at` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `updated_at` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), PRIMARY KEY (`id`)) ENGINE=InnoDB");
